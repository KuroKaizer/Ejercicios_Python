...
class Persona:
    ...
    def set_id_perona(self,id_persona):
        self.__id_persona = id_persona    
             

if __name__ == '__main__':
    persona1 = Persona(1, 'Juan', 'Ruffo', 'Jruffo@mail.com')
    ...
    #Simular elimniar un objeto de tipo perona
    perona3 = Persona(id_persona=3)
    logger.debug(perona3)             
